...
export default function AddTaskModal({ onSave, taskToUpdate, onCloseClick }) {
  ...
  const [isAdd, setIsUpdate] = useState(Object.is(taskToUpdate, null));
  // handle change function to update the task state
  ...
  return (
    <>
      <div className="bg-black/70 h-full w-full z-10 absolute top-10 left-0"></div>
      <form className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/4 left-1/4">
        ...
        <div className="mt-16 flex justify-center lg:mt-20 gap-6">
          <button
            type="submit"
